                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="password" name="password_confirm" value=""
                                class="form-control @error('password_confirm') is-invalid @enderror" placeholder="Confirm Password">
                        ...
                        <div class="col-md-6 w-100 mt-3">
                            ...
                            <div class="mb-3">
                                <select class="form-select w-100" name="roles[]" multiple>
                                    ...
                                    <option {{ (old('roles') === $role->name) ? 'seleceted': ''  }} value="{{ $role->name }}">{{ $role->name }}</option>
                                    @endforeach
                                </select>
                            </div>
